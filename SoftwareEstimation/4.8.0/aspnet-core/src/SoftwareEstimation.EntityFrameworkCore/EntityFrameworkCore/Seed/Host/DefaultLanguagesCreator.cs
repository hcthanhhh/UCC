...
namespace SoftwareEstimation.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = SoftwareEstimationConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(SoftwareEstimationDbContext context)
        {
            _context = context;
        }
